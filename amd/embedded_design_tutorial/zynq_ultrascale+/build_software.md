...
**Note**
You can use any serial communication utility in your system. The Vitis IDE provides a serial terminal utility. We will use it throughout the tutorial; select **Window → Show View → Xilinx -> Vitis** Serial Terminal in Vitis IDE to open it.
...
More debugging techniques are explored in the [next chapter](debugging_apps.md).
