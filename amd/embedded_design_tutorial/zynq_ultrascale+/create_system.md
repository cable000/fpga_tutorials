...
The tutorials are based on the tutorials found on AMD's (Xilinx) [github](https://xilinx.github.io/Embedded-Design-Tutorials/docs/2021.2/build/html/docs/Introduction/ZynqMPSoC-EDT/ZynqMPSoC-EDT.html) site.
